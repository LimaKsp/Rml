...
function abrir() {
  if (itens.style.display == "flex") {
    ...
    navBar.style.borderBottom = "dashed 3px rgb(45, 247, 17, 255)";
  }
}
...
function validateform() {
  ...
  if (valido === true) {
    document.querySelector(".body").classList.add("escondido");
    document.querrySelector(".tela2").classList.remove("escondido");
  }
}
